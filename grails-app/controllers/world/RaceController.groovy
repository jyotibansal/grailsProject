...
class RaceController {
    ...
    def save(Race raceInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'raceInstance.label', default: 'Race'), raceInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'raceInstance.label', default: 'Race'), params.id])
                redirect action: "index", method: "GET"
            }
